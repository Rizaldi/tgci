...
<html>
	<head>
		...
		<?php $this->load->view('components/page_css'); ?>
		<!-- Vendor CSS -->
	...
	<body>
					...
					<div id="revolutionSlider" class="slider rev_slider" data-plugin-revolution-slider data-plugin-options='{"gridwidth": 800, "gridheight": 700}'>
						<ul>
							<li data-transition="fade">
								<img src="<?php echo base_url('assets'); ?>/img/slides/sl1.jpg"  
									alt=""
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-md-12 center">
							...
							<p class="lead">Trusted by over 19,000 satisfied users, Porto is a huge success<br>in the of one of the world’s largest MarketPlace.</p>
						</div>
					</div>
		...
		<?php $this->load->view('components/page_js'); ?>
	</body>
</html>